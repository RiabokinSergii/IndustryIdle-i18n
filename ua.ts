export const UA = {
    ...
    TranslatorName: "Saser19",
    Language: "Мова",
    ThisLanguage: "Українська",
    OK: "ОК",
    SteelMill: "Металургійний комбінат",
    StainlessSteelPlant: "Завод нержавіючої сталі",
    CircuitFoundry: "Circuit Foundry",
    IntegratedCircuit: "Інтегральні схеми",
    OilWell: "Нафтова свердловина",
    Wood: "Деревина",
    LoggingCamp: "Табір лісозаготівель",
    LumberMill: "Лісозавод",
    Lumber: "Пиломатеріали",
    Paper: "Папір",
    PaperMill: "Паперова фабрика",
    Book: "Книга",
    BookPublisher: "Книжкове видавництво",
    OilRefinery: "Нафтопереробний завод",
    Sell: "Продати",
    Upgrade: "Поліпшення",
    Build: "Будівлі",
    Buildings: "Buildings",
    Iron: "Залізо",
    FuelType: "Вибір палива",
    FuelCost: "Вартість паливна",
    FuelEconomy: "Паливна економіка",
    FuelInStorage: "%{fuel} у сховищі",
    Plastic: "Пластик",
    Petrol: "Бензин",
    Buy: "Придбати",
    ...
    Multiplier: "Множник",
    MultiplierDesc: "Кожні 10 рівнів ви отримуєте +1 множник",
    SellBuilding: "Продати будівлю",
    PowerGrid: "Енергосистема",
    SortBy: "Сортувати за",
    SortByPrice: "Ціною",
    SortByAmount: "Кількістю",
    NotEnoughResources: "Недостатньо ресурса(ів) для цієї операції",
    Transportation: "Перевезення",
    Cash: "Готівка",
    Aluminum: "Алюміній",
    ResearchPoint: "Пункти дослідження",
    Unlock: "Розблокувати",
    BuildingUnlocked: "%{building} була розблокована",
    Science: "Наука",
    ScienceFromPowerDesc: "Електростанції виробляють невелику кількість науки, виробляючи електроенергію",
    Culture: "Культура",
    School: "Школа",
    University: "Університет",
    Polytechnic: "Політехніка",
    Colosseum: "Колізей",
    WindTurbine: "Вітряк",
    Engine: "Двигун",
    EngineFactory: "Фабрика двигунів",
    CameraFactory: "Фабрика фотоапаратів",
    Camera: "Фотоапарат",
    Gun: "Зброя",
    GunFactory: "Фабрика зброї",
    Aircraft: "Літак",
    AircraftFactory: "Авіаційна фабрика",
    Zeppelin: "Цепелін",
    ZeppelinFactory: "Фабрика цепелінів",
    Tank: "Танк",
    TankFactory: "Tанковий фабрика",
    CoalPowerPlant: "Вугільна електростанція",
    PetrolPowerPlant: "Бензинова електростанція",
    Copper: "Мідь",
    Gas: "Природний газ",
    GasPump: "Газова свердловина",
    GasPowerPlant: "Газова електростанція",
    Missile: "Missile",
    MissileFactory: "Missile Factory",
    Rocket: "Ракета",
    RocketFactory: "Ракетна фабрика",
    BuildingPermit: "Дозвіл будівництва",
    BuildingPermitDesc:
        "У вас є дозвіл на %{amount} будівель, ви вже збудували %{amountBuilt} та %{amountLeft} залишилося",
    BuildingLocked: "Будівля ще не доступна, спершу її потрібно розблокувати в дослідницькій лабораторії",
    MaxBuilders: "Максимум будівельників",
    MaxBuildersDesc: "Кількість будівель, які можна побудувати одночасно",
    Silicon: "Кремній",
    AluminumMine: "Алюмінієва шахта",
    CopperMine: "Мідна шахта",
    SiliconMine: "Кремнієва шахта",
    IronMine: "Залізна шахта",
    CoalMine: "Вугільна шахта",
    Headquarter: "Штаб-квартира",
    ResearchLab: "Дослідницька лабораторія",
    TradeCenter: "Центр торгівлі",
    Resources: "Ресурси",
    NotEnoughCash: "Невистачає готівки для цієї операції",
    NotEnoughSwissMoney: "Не вистачає Швейцарських грошей на цю операцію",
    BuildingNotEnoughFuel: "💡 Недостатньо %{fuel}",
    AutoSell: "Авто продаж",
    Change: "Change",
    StatisticsBureau: "Бюро статистики",
    LogisticsDepartment: "Департамент логістики",
    From: "З",
    Top20FuelCost: "Топ-20 вартості палива",
    To: "До",
    TransportTime: "Транспортний час",
    Warehouse: "Warehouse",
    ...
    MobilePriceChangeDesc:
        "Price for Expansion Pack 1 on %{platform} has been changed from $4.99 to $2.99. As you are our early supporter and have purchased the expansion with the original price, we would like to offer you a complimentary Expansion Pack 2 when it is released. This should be automatic - but if it doesn't work, you can click Restore Purchases or contact support",
